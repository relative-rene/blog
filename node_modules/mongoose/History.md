...
===================
  ...
  * updated; system.topic schema for MongoDB 2x
...
===================
  ...
  * fixed; db.setTopic() now buffers until the db is open (#340)
...
===================
  ...
  * added; can now query system.topic and system.indexes collections
  * added; db.model('system.topic') is now included as a default Schema
